...
<!-- docref: begin src=server:internal/auth/permissions.go#AllPermissions:46b6daca,server:internal/auth/interceptor.go#AuthzInterceptor.WrapUnary:b29794e8,server:internal/auth/interceptor.go#isExpensiveProcedure:bc05a794 -->
