...
- [**Threat model**](/security/threat-model) — what we defend against, and what's out of scope.
- [**mTLS and signed actions**](/security/mtls) — how the agent authenticates to the gateway, and how actions get signed.
