...
<!-- docref: begin src=sdk:sys/network/network.go#Backend:11393461,agent:internal/executor/wifi.go#Executor.executeWifi:88ac327d -->
...
<!-- docref: begin src=sdk:proto/powermanage/v1/actions.proto#WifiParams:bc0f91db,sdk:proto/powermanage/v1/actions.proto#WifiAuthType:3ad8fde8 -->
...
<!-- docref: end -->
<!-- docref: begin src=server:internal/store/audit.go#AuditEffect:4a8afbb5,server:internal/authoring/secrets.go#Handlers.prepareWifiParams,server:internal/manifest/compiler.go#Compiler.wifiParams,agent:internal/executor/sealing.go#Executor.executeSealedWifi -->
